...
BASE_DIR = '/ssd_scratch/cvit/shaon/subj08'
TRAIN_DIR = os.path.join(BASE_DIR, f'training_split')
STIMULI_DIR = os.path.join(TRAIN_DIR, 'training_images')
FMRI_DIR = os.path.join(TRAIN_DIR, 'training_fmri')
ROI_MASKS_DIR = os.path.join(BASE_DIR, f'roi_masks')
...
def analyze_results(results):
    ...
    sns.scatterplot(x='Correlation', y='R²', hue='Model', size='ROI', data=df, sizes={'V3v': 100, 'FBA-2': 200})
